function [data, voxSize, omeMeta]=cziPrep3chan(fileIn)
%% to do
...
data.channel1(:,:,z)=double(datacell{1,1}{3*z-2,1}); % get channel 1 (prob blue)
data.channel2(:,:,z)=double(datacell{1,1}{3*z-1,1}); % get channel 2 (prob red)
data.channel3(:,:,z)=double(datacell{1,1}{3*z,1}); % get channel 2 (prob red)
